...
function Header() {
  ...
  return (
    <div className=' bg-gradient-to-br from-blue-600  via-purple-700  to-violet-600 backdrop-blur-3xl  fixed  w-full right-0 top-0 flex justify-between items-center p-5 shadow-md border-b-2'>
